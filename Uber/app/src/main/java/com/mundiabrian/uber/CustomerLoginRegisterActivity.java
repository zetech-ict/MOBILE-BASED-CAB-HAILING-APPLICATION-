            ...
            mAuth.signInWithEmailAndPassword(email,password)
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task)
                        {
                            ...
                            {
                                Toast.makeText(CustomerLoginRegisterActivity.this, "Customer logged in Successful...", Toast.LENGTH_SHORT).show();
                                LoadingBar.dismiss();
                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task)
                        {
                            if(task.isSuccessful())
                            {
                                ...
                                Toast.makeText(CustomerLoginRegisterActivity.this, "Customer Registration in Successful...", Toast.LENGTH_SHORT).show();
                                LoadingBar.dismiss();
